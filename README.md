...
- **Selection sync** — clicking a highlight in the reader text or in Zotero's own native annotations sidebar selects and scrolls to the matching row in the Groups panel, in both directions, and moves keyboard focus to the panel so the arrow keys carry on from there
...
| `arrowKeysScroll`                                       | `false`                      | ↑/↓ scroll the panel instead of stepping to the previous/next annotation              |
